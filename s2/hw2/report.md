...
FROM cinema.review
WHERE rating IN (9, 10);
```
-- БЕЗ ИНДЕКСОВ
![Screenshot 2026-03-03 at 19.07.01.png](screenshots/Screenshot%202026-03-03%20at%2019.07.01.png)
-- B-tree индекс
![Screenshot 2026-03-03 at 19.09.15.png](screenshots/Screenshot%202026-03-03%20at%2019.09.15.png)
```sql
-- 5.2
EXPLAIN (ANALYZE, BUFFERS)
SELECT review_id, user_id, movie_id, rating
...
```
-- БЕЗ ИНДЕКСОВ
![Screenshot 2026-03-03 at 19.07.27.png](screenshots/Screenshot%202026-03-03%20at%2019.07.27.png)
-- B-tree индекс
![Screenshot 2026-03-03 at 19.09.38.png](screenshots/Screenshot%202026-03-03%20at%2019.09.38.png)
...
**5 запрос**
Без индекса: Seq Scan, Execution time: 29 ms, Cost: 5362
B tree индекс: Bitmap Heat Scan, Execution time: 19 ms, Cost: 3424